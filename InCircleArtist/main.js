...
async function main() {
  ...
  checkNFT.onclick = async function () {
    ...
    if (tokenBalance < 1) {
      ...
      window.open("https://yvonne213.github.io/Projects/InCircleArtist/check", "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,top=400,left=500,width=900, height=350")
